...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { descripcion: @proyecto.descripcion, etapa: @proyecto.etapa, nombre: @proyecto.nombre, proposito: @proyecto.proposito, user_id: @proyecto.user_id, web: @proyecto.web } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { descripcion: @proyecto.descripcion, etapa: @proyecto.etapa, nombre: @proyecto.nombre, proposito: @proyecto.proposito, user_id: @proyecto.user_id, web: @proyecto.web } }
