...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { nombre: @empresa.nombre, rubro: @empresa.rubro, tamaño: @empresa.tamaño, tipo: @empresa.tipo, user_id: @empresa.user_id, web: @empresa.web } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { nombre: @empresa.nombre, rubro: @empresa.rubro, tamaño: @empresa.tamaño, tipo: @empresa.tipo, user_id: @empresa.user_id, web: @empresa.web } }
